...
/**
 * Maintains a list of all hooks and registers them with WordPress on run().
 */
class AppointKit_Loader {
	 ...
	 *
	 * @param array  $hooks         The collection of hooks already registered (either actions or filters).
	 * @param string $hook          The name of the WordPress filter/action hook.
	 * @param object $component     A reference to the instance of the object on which the filter/action is defined.
	 * @param string $callback      The name of the function definition on the $component.
