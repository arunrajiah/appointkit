 ...
 */
class AppointKit_Customer_Booking_Cancelled {
	...
	public function send() {
		...
		$subject = sprintf(
			...
			__( 'Booking Cancelled – %s', 'appointkit' ),
			get_bloginfo( 'name' )
		);
	...
	private function build_message( AppointKit_Booking $booking ) {
		ob_start();
		include APPOINTKIT_PLUGIN_DIR . 'templates/emails/customer-booking-cancelled.php';
		return ob_get_clean();
	}
}
